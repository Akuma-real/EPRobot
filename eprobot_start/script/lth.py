            ...
            while not (rospy.is_shutdown() or self.flag):
                if self.color == 1:
                    if self.sendgoal_flag == 4 and self.this_pose_x >= lim_x1 and self.this_pose_x <= max_x1 and self.this_pose_y >= lim_y1 and self.this_pose_y <= max_y1 :
                        ...
                        time.sleep(0.1)
                        self.flag = 1
                    if self.sendgoal_flag == 1 and self.this_pose_x >= -0.5 and self.this_pose_x <= 0.4: #and self.this_pose_y >= -0.75 and self.this_pose_y <= -0.5 :
                        self.send_goal1()
                        self.sendgoal_flag = 3
                        self.color = 0
                        time.sleep(0.1)
                    if self.sendgoal_flag == 5 and self.this_pose_x >= lim_x3 and self.this_pose_x <= max_x3 and self.this_pose_y >= lim_y3 and self.this_pose_y <= max_y3 :
                        self.send_goal5()
                        self.sendgoal_flag = 3
                        time.sleep(15)
                    ...
                    if self.sendgoal_flag == 3 and self.this_pose_x >= lim_x4 and self.this_pose_x <= max_x4 and self.this_pose_y >= lim_y4 and self.this_pose_y <= max_y4 :
                        self.send_goal3()
                        self.sendgoal_flag = 4
                        time.sleep(0.1)
                    ...
                    if self.sendgoal_flag == 4 and self.this_pose_x >= lim_x1 and self.this_pose_x <= max_x1 and self.this_pose_y >= lim_y1 and self.this_pose_y <= max_y1 :
                        ...
                        time.sleep(0.1)
                        self.flag = 1
                    if self.sendgoal_flag == 1 and self.this_pose_x >= lim_x2 and self.this_pose_x <= max_x2 and self.this_pose_y >= lim_y2 and self.this_pose_y <= max_y2 :
                        self.send_goal1()
                        self.sendgoal_flag = 3
                        time.sleep(0.1)
                    if self.sendgoal_flag == 2 and self.this_pose_x >= lim_x3 and self.this_pose_x <= max_x3 and self.this_pose_y >= lim_y3 and self.this_pose_y <= max_y3 :
