...
echo_and_run cd "/home/EPRobot/robot_ws/src/navigation-melodic-huanyu/base_local_planner"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/EPRobot/robot_ws/src/navigation-melodic-huanyu/base_local_planner/setup.py" \
     \
    build --build-base "/home/EPRobot/robot_ws/build/navigation-melodic-huanyu/base_local_planner" \
    install \
    --root="${DESTDIR-/}" \
