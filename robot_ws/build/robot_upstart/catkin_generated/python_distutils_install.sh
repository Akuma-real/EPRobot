...
echo_and_run cd "/home/EPRobot/robot_ws/src/robot_upstart"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/EPRobot/robot_ws/src/robot_upstart/setup.py" \
     \
    build --build-base "/home/EPRobot/robot_ws/build/robot_upstart" \
    install \
    --root="${DESTDIR-/}" \
